...
const S3Card = forwardRef<HTMLDivElement, { index: number; isActive?: boolean; cardData: { img: string; title: string } }>(function S3Card({ index, isActive = false, cardData }, ref) {
    return (
        <div
            ref={ref}
        ...
        >
            <div className="relative w-[95%] h-[95%] rounded-full overflow-hidden">
               ...
               {cardData.title && <div className="absolute inset-0  w-full h-full flex justify-center items-center text-center">
