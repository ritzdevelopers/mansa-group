            ...
            <div className={`${styles.container} w-full px-4 sm:px-6 md:px-10 lg:px-0 lg:pl-18 flex flex-col lg:flex-row justify-between items-center gap-8 lg:gap-0`}>
                ...
                <div className="w-full lg:w-[calc(100%-600px)] xl:w-[calc(100%-829px)] h-full flex justify-start items-start">
                    ...
                    >
                        ...
                        <button className="w-[140px] sm:w-[156px] h-[34px] sm:h-[37px] text-white bg-[#144168] flex items-center justify-center transition-transform cursor-pointer duration-200 ease-out hover:scale-105 active:scale-[0.98]">
                ...
                <motion.div
                    className="w-full lg:w-[550px] xl:w-[829px]"
                    initial={{ opacity: 0, x: 36 }}
                    whileInView={{ opacity: 1, x: 0 }}
                    viewport={{ once: true, amount: 0.2 }}
