    ...
    return (
        <section className="w-full px-4 sm:px-6 md:px-10 lg:px-16 flex justify-center bg-[#652A27] items-center">
            <div className={`${styles.container} w-full relative py-8 sm:py-10 md:py-12 lg:py-[66px]`}>
                <motion.div
                    className="flex flex-col gap-3 sm:gap-6 text-center lg:text-left"
                ...
                <motion.div
                    className="absolute bottom-0 right-0 sm:right-4 md:right-10 lg:right-0 xl:right-20 z-10 pointer-events-none"
